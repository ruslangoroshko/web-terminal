  ...
  useEffect(() => {
    const widgetOptions: ChartingLibraryWidgetOptions = {
      ...
      overrides: {
        ...
        'mainSeriesProperties.candleStyle.upColor': '#3BFF8A',
        'mainSeriesProperties.candleStyle.downColor': '#ed145b',
        'mainSeriesProperties.candleStyle.drawWick': true,
        'mainSeriesProperties.candleStyle.drawBorder': true,
        'mainSeriesProperties.candleStyle.borderColor': '#3BFF8A',
        'mainSeriesProperties.candleStyle.borderUpColor': '#3BFF8A',
        'mainSeriesProperties.candleStyle.borderDownColor': '#ed145b',
        'mainSeriesProperties.candleStyle.wickUpColor': '#3BFF8A',
        'mainSeriesProperties.candleStyle.wickDownColor': '#ed145b',
