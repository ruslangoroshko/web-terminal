...
import { CreatePayopInvoiceParams } from '../../types/DepositTypes';
...
const Payop = () => {
  ...
  const handleSubmitForm = async (values: any) => {
    ...
    try {
      const result = await API.createPayopInvoice(params);
  ...
  useEffect(() => {
    mixpanel.track(mixpanelEvents.DEPOSIT_METHOD_VIEW, {
      [mixapanelProps.DEPOSIT_METHOD]: depositMethod.PAYOP,
    });
  }, []);
