import { CreatePayRetailersInvoiceParams, CreatePayRetailersInvoiceDTO, CreateVoltInvoiceDTO, CreateVoltInvoiceParams } from './../types/DepositTypes';
...
class API {
  ...
  createVoltInvoice = async (
    params: CreateVoltInvoiceParams
  ) => {
